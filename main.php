    ...
    <script type="text/javascript">
      function validasi_input(form){
        ...
        if (form.nip.value.length != car){
          alertify.alert('Warning', "NIP harus 18 Karater!");
          form.nip.focus();
          return (false);
        }
         return (true);
  ...
  <body class="nav-md">
      ...
      <div class="main_container">
          ...
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="main.php?module=home" class="site_title">
                <div class="logo_pic"><img src="images/187474.png" alt="..." class="img-lgkrn logo_img"></div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="logout.php" class="logout"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                  </ul>
                </li>
        ...
        <footer>
          <div class="pull-right">
            Master Project Pemrograman Web &copy; <?php echo date('Y'); ?>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
    ...
    <script>
      ...
      $(document).ready(function() {
        ...
        var guruArray = $.map(guru, function(value, key) {
          return {
            value: value,
            data: key
          };
        ...
        $('#autocomplete-guru').autocomplete({
          lookup: guruArray,
          appendTo: '#autocomplete-container-guru'
        });
      });
    </script>
