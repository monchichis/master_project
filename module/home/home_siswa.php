...
<div class="right_col" role="main">
                    ...
                    <div class="demo-container">
                    	<table>
                      		...
                      		<tr>
                      			<td>Kelas</td>
                      			<td>:</td>
                      			<td><?php echo $sw['tingkat_kelas']." / ".$sw['nama_jurusan']; ?></td>
                      		</tr>
                      		<tr>
                      			<td>Alamat</td>
                      			<td>:</td>
    ...
    <h4 align="center">Anda dapat melakukan pengecekan detail poin pelanggaran dan prestasi dengan klik tombol di bawah ini</h4>
    <br>
