                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="hakAkses" class="form-control" required="required" id="test" onchange="showDiv()">
                            ...
                            <option value="5">Siswa / Orang Tua</option>
                          </select>
                        </div>
                      </div>
                      <!--
                    ...
                    -->
                     ...
                     <div id="hidden_nip">
                      ...
                      <div class="form-group" >
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="guru" id="autocomplete-guru" class="form-control col-md-10" style="float: left;" />
                          <div id="autocomplete-container-guru" style="position: relative; float: left; width: 400px; margin: 10px;"></div>
                        </div>
                      </div>

                    </div>
                      <div class="form-group" id="hidden_ortu">
...
<script src="https://code.jquery.com/jquery-3.5.1.min.js"></script>
       ...
       k(document).ready(function() {
         k('#hakAkses').click(function() {
             var template = k('#hakAkses').val();
             if (template == 1) {
                 k('#ortu').hide();
                 // $('#nip').show();
                 // $('#jabatan').show();
