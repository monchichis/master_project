...
if (empty($_SESSION['namauser']) AND empty($_SESSION['passuser'])) {
	...
	$queryEdit = mysqli_query($connect,"UPDATE user SET username='$username', password='$pass', hak_akses='$hakAkses' WHERE id_login='$idLogin'" );
	...
	if ($queryEdit) {
		...
		// echo "<script> alert('Data User Gagal Diubah'); window.location='$base_url'+'main.php?module=edit_user&id_login='+'$idLogin';</script>";
         ...
         $url=$base_url.'main.php?module=edit_user&id_login='.$idLogin;
